...
public class DFSConfigKeys extends CommonConfigurationKeys {
	...
	public static final String  DFS_OPENFLOW_TRAFFIC_ANALYZER_SERVER_PORT = "dfs.openflow.server.port";
	public static final int     DFS_OPENFLOW_TRAFFIC_ANALYZER_DEFAULT_SERVER_PORT = 5050;
