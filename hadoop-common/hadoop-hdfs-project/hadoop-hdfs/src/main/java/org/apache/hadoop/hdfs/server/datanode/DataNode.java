...
import org.apache.hadoop.hdfs.openflow.server.HDFSOpenFlowServiceServer;
import org.apache.hadoop.hdfs.openflow.server.HDFSTrafficDelay;
...
public class DataNode extends Configured 
  ...
  private HDFSOpenFlowServiceServer server = null;
  private HDFSTrafficDelay delays = null;
  ...
  DataNode(final Configuration conf,
    ...
    //openflow daemon starts here
    int hdfsOpenflowTrafficServerPort = conf.getInt(DFSConfigKeys.DFS_OPENFLOW_TRAFFIC_ANALYZER_SERVER_PORT, DFSConfigKeys.DFS_OPENFLOW_TRAFFIC_ANALYZER_DEFAULT_SERVER_PORT);
    this.delays = new HDFSTrafficDelay();
    this.server = new HDFSOpenFlowServiceServer(hdfsOpenflowTrafficServerPort, delays);
  ...
  public HDFSTrafficDelay getHDFSOpenflowMeasuredDelay(){
	  return this.delays;
  }
 ...
 */
  ...
  private class DataTransfer implements Runnable {
    ...
    /**
     * Do the deed, write the bytes to another datanode
     */
    @Override
    public void run() {
      ...
      try {
        ...
        // send data & checksum
        blockSender.sendBlock(out, unbufOut, null, null, null);
